  ...
  <div>
    <el-dialog
      ...
      <el-form
        ...
        <el-row gutter="15">
          <el-col :span="7">
            <el-form-item label="二面成绩1" label-width="100px" prop="score2_1">
              <el-input-number  size="small" v-model="selectedUser.score2_1" @change="handleChange" :min="1" :max="30" ></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="7">
            <el-form-item label="二面成绩2" label-width="110px" prop="score2_2">
              <el-input-number  size="small" v-model="selectedUser.score2_2" @change="handleChange" :min="1" :max="30" ></el-input-number>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="7">
            <el-form-item label="二面成绩3" label-width="120px" prop="score2_3">
              <el-input-number  size="small" v-model="selectedUser.score2_3" @change="handleChange" :min="1" :max="40" ></el-input-number>
              </el-input>
            </el-form-item>
          </el-col>
    ...
    <el-card style="margin: 18px 2%;width: 95%">
      <el-table
        :data="users"
        v-loading="loading"
        element-loading-text="请输入手机号"
        element-loading-spinner="el-icon-loading"
        element-loading-background="rgba(0, 0, 0.3, 0.3)"
        stripe
...
<script>
  ...
  export default {
    ...
    methods: {
      listUsers () {
        var _this = this
        this.$axios.get('club/api/bsplist?bm='+this.mstype+'&status=2&phone='+this.phone).then(resp => {
      ...
      onSubmit (user) {
        this.$axios.put('/club/update_2', {
          ...
          if (resp && resp.data.rspCode === '200') {
            this.$message.success("审核完成：二面分数已更新")
