  ...
  <div>
    <el-dialog
      ...
      <el-form v-model="selectedUser"
        ...
        <el-form-item label="微信OpenID" label-width="120px" prop="name">
          <el-input v-model="selectedUser.wxuid" autocomplete="off"></el-input>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          @click="onSubmit_ref(selectedUser.wxuid)"
  ...
  import BulkRegistration from './BulkRegistration'
    export default {
      ...
      methods: {
        ...
        onSubmit_ref(wxuid){
          var _this = this
          this.$axios.get('carefresh?cache='+wxuid,{
          }).then(resp => {
            if (resp && resp.data.rspCode === '200') {
        ...
        onSubmit_dele (user) {
          this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
            ...
            this.$axios.post('/userdelete', this.selectedUser).then(resp => {
              if (resp && resp.data.rspCode === '200') {
                this.$alert('用户删除成功')
